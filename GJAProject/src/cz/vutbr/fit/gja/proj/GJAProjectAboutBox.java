...
public class GJAProjectAboutBox extends javax.swing.JDialog {
   ...
   */
  public GJAProjectAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
  ...
  @Action public void closeAboutBox() {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(cz.vutbr.fit.gja.proj.GJAProjectApp.class).getContext().getResourceMap(GJAProjectAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(cz.vutbr.fit.gja.proj.GJAProjectApp.class).getContext().getActionMap(GJAProjectAboutBox.class, this);
